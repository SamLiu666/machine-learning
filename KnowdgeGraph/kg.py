...
# read data
candidate_sentences = pd.read_csv("E:\chrome download\paper\corpus\wiki_sentences_v2.csv")
print("Sentences numbers: ",candidate_sentences.shape)
print("----------------------------------------------------------------\n")
