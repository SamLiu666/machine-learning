...
history = model.fit(x_train, y_train, epochs=40, batch_size=256, validation_data=(x_val, y_val), verbose=1)
...
with open("test.txt", encoding="utf-8") as file:
    for line in file.readlines():
        ...
        encode = review_encode(nline)  # 在字典中找到对应的数字
        encode = keras.preprocessing.sequence.pad_sequences([encode], value=word_index['<PAD>'], padding="post", maxlen=256)  # 编码
